  ...
  <div class="vertical-center">
    <div id="filter-container" class="e-resizable">
      ...
      <div>
        ...
        href = "/vehicle/${selectedOption}">View Car</b-button>
      </div>
    </div>
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      cTemplate: function () {
        return {
          template: Vue.component("vehicleTemplate", {
  ...
  methods: {
    ...
    onRowSelected(args) {
      console.log("Current row details - " + JSON.stringify(args));
      this.selectedOption = args.data._id;
    },
    goToPage() {},
  },
  provide: {
